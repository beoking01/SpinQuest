...
public class LocalizationCollection : ScriptableObject
{
	...
	private const string CSVCollectionPath = "Assets/ScriptableObject/CSVCollectionManager/MyCSVManager.asset";
	...
	public void PopulateDataFromCSV()
	{
		...
		{
			Debug.LogError($"CSVCollectionManager not found at: {CSVCollectionPath}");
			return;
		}

		TextAsset textAsset = collectionManager.GetCollection(nameof(LocalizationData));
		if (textAsset == null)
		{
